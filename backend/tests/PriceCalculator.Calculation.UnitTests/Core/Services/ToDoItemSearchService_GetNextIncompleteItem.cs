...
using Price_Calculator.Backend.Core.ProjectAggregate;
using Price_Calculator.Backend.Core.Services;
using Price_Calculator.Backend.SharedKernel.Interfaces;
using Moq;
using Xunit;

namespace Price_Calculator.Backend.UnitTests.Core.Services
{
