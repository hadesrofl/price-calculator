...
{
  private static Calculation CreateCalculation(int salesVolume, Amount amount)
  {
    return CalculationFactory.Create(salesVolume, amount);
  }

  private static Calculation CreateCalculation(int salesVolume, Amount amount, IEnumerable<Cost> costs)
  {
